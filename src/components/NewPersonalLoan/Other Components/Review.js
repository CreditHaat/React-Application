                                    ...
                                    <div class="reviw-snap_img">
                                        <div class="reviw-profile_card">
                                            <div class="reviw-profile_card-img">
                                                <img src="https://credithaatimages.s3.ap-south-1.amazonaws.com/siteimages/Deepak.jpeg" style={{ height: '60px', width: '60px' }} />
                                            </div>
                                        ...
                                        <div class="reviw-snap_cont">
                                            <p style={{ display: 'flex' }}>Applying for a loan from CreditHaat is so easy and hasselfree. The platform helped me avail a loan of ₹5 Lacs within 4 hours!</p>
                                        </div>
                                    </div>
                                    <div class="reviw-snap_img">
                                        <div class="reviw-profile_card">
                                            <div class="reviw-profile_card-img">
                                                <img src="https://credithaatimages.s3.ap-south-1.amazonaws.com/siteimages/Ekta.jpeg" style={{ height: '60px', width: '60px' }} />
                                            </div>
                                            <div class="reviw-profile_name">
                                                <h6> Ekta </h6>
                                                <div class="reviw-profile_work">
