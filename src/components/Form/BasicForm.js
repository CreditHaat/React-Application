...
import gif from '../../images/Untitled_design-removebg-preview-removebg-preview1.png';
import Animation from './Animation';
import EditIcon from '@mui/icons-material/Edit';
import SaveIcon from '@mui/icons-material/Save';
import img from '../../images/Experian.svg';
import { Box,Button,Checkbox,Grid,TextField,Typography,Snackbar,IconButton,FormControl, InputLabel, Input} from '@mui/material';
...
const FormFooter = React.lazy (() => import('./FormFooter'));
  ...
  return (
        ...
        <section className="container banner" id='containerb'>
          <div className="row" style={{ display: 'flex' }}>
            <div className="col-md-6" style={{ textAlign: 'end',display:'none'}} id="afterload">
              ...
              >
                <span style={{loading:'lazy'}}>
                  {' '}
                  Turn Plans into Reality <br />
                  Explore Our Range of Flexible Loans
                </span>
              </Root>
              <br/>
    ...
    <Card
      ...
      <CardContent sx={{ maxWidth: '40ch' }}>
        ...
        <Carousel responsive={responsive} sx={{ loading: "lazy" }}>
      {cardData.map((item) => (
    <Card
      data-resizable
      key={item.id}
      ...
      <br/>
      <CardContent sx={{ maxWidth: '40ch',marginTop:'20px'}}>
            ...
            <div style={{ marginTop: '15px', loading:"lazy"  }}>
                <div className="brandcontainer" style={{ display: 'flex', height: 'auto', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', margin: '20px' }}>
                    ...
                    <div className="brandbox" style={{ margin: '20px' }}>
                        <img style={{ height: '50px', width: '50px', margin: 'auto', borderRadius: '2px' ,  loading:"lazy"}} src="https://chdocsusers.s3.ap-south-1.amazonaws.com/partners/ABFL.png" alt="ABFL" />
                        <p className="brandname" style={{ fontSize: '10px', textAlign:'center',fontFamily:'Raleway',fontWeight:'600' }}>ABFL</p>
                    </div>

                    <div className="brandbox" style={{ margin: '20px' }}>
                        <img style={{ height: '50px', width: '50px', margin: 'auto', borderRadius: '2px' ,  loading:"lazy" }} src="https://chdocsusers.s3.ap-south-1.amazonaws.com/partners/fibe.png" alt="Fibe" />
                        <p className="brandname" style={{ fontSize: '10px', textAlign:'center',fontFamily:'Raleway',fontWeight:'600' }}>Fibe</p>
                    </div>

                        <div className="brandbox" style={{ margin: '20px' }}>
                            <img style={{ height: '50px', width: '50px', margin: 'auto', borderRadius: '2px' ,  loading:"lazy" }} src="https://chdocsusers.s3.ap-south-1.amazonaws.com/partners/smartcoin.jpg" alt="Smartcoin" />
                            <p className="brandname" style={{fontSize: '10px', textAlign:'center',fontFamily:'Raleway',fontWeight:'600'}}>Smartcoin</p>
                        </div>

                        <div className="brandbox" style={{ margin: '20px' }}>
                            <img style={{ height: '50px', width: '50px', margin: 'auto', borderRadius: '2px' ,  loading:"lazy" }} src="https://credithaatimages.s3.ap-south-1.amazonaws.com/siteimages/MoneyView.webp" alt="Moneyview" />
                            <p className="brandname" style={{fontSize: '10px', textAlign:'center',fontFamily:'Raleway',fontWeight:'600'}}>Moneyview</p>
                        </div>

                        <div className="brandbox" style={{ margin: '20px' }}>
                            <img style={{ height: '50px', width: '50px', margin: 'auto', borderRadius: '2px' ,  loading:"lazy" }} src="https://credithaatimages.s3.ap-south-1.amazonaws.com/siteimages/StashFin.webp" alt="Stashfin" />
                            <p className="brandname" style={{fontSize: '10px', textAlign:'center',fontFamily:'Raleway',fontWeight:'600'}}>Stashfin</p>
                        </div>

                        <div className="brandbox" style={{ margin: '20px' }}>
                            <img style={{ height: '50px', width: '50px', margin: 'auto', borderRadius: '2px' ,  loading:"lazy"}} src="https://chdocsusers.s3.ap-south-1.amazonaws.com/partners/kreditbee.png" alt="Kreditbee" />
                            <p className="brandname" style={{fontSize: '10px', textAlign:'center',fontFamily:'Raleway',fontWeight:'600'}}>Kreditbee</p>
                        </div>

                        <div className="brandbox" style={{ margin: '20px' }}>
                            <img style={{ height: '50px', width: '50px', margin: 'auto', borderRadius: '2px' ,  loading:"lazy" }} src="https://chdocsusers.s3.ap-south-1.amazonaws.com/partners/zype.png" alt="Zype" />
                            <p className="brandname" style={{fontSize: '10px' , textAlign:'center',fontFamily:'Raleway',fontWeight:'600'}}>Zype</p>
                        </div>

                        <div className="brandbox" style={{ margin: '20px' }}>
                            <img style={{ height: '50px', width: '50px', margin: 'auto', borderRadius: '2px' ,  loading:"lazy" }} src="https://credithaatimages.s3.ap-south-1.amazonaws.com/siteimages/MoneyTap.webp" alt="Moneytap" />
        ...
        <img style={{ height: '50px', width: '120px', margin: 'auto', borderRadius: '2px', display:'flex', marginTop: '20px',  loading:"lazy" }} src={img} alt="" />
